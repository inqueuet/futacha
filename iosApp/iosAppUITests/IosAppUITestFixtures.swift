// Synthetic video fixtures for IosAppUITests. The WebM stability dictionary at the
// end is rewritten by tools/generate-webm-test-fixtures.py --update-swift.

// Synthetic video bytes are confined to the UI test target.
let originalVideoMp4Fixture =
...
let webmStabilityFixtures: [String: String] = [
    "broken.webm": [
