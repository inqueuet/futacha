...
class IosFileSystemPathSupportTest {
    ...
    @Test
    fun resolveIosAbsolutePath_routes_internal_state_to_private_root() {
        assertEquals(
        ...
        assertEquals(
            "$privateAppDataDirectory/compatibility/compatibility.db",
            resolveIosAbsolutePath(
                relativePath = "compatibility/compatibility.db",
                appDataDirectory = appDataDirectory,
                privateAppDataDirectory = privateAppDataDirectory
            )
        )
