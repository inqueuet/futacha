...
class ThreadScreenLoadLogicTest {
    ...
    fun threadScrollRestoreHelpers_clampAndFormatFailureMessage() {
        ...
        val posts = listOf("100", "101", "102").mapIndexed { index, id ->
        ...
        assertEquals(
            ThreadScrollRestoreTarget(index = 4, offset = 12),
            resolveThreadScrollRestoreTarget(
                savedIndex = 99,
                savedOffset = 12,
                totalItems = 6,
    ...
    fun threadLoadStateHelpers_buildSuccessAndFailureState() {
        ...
        val history = listOf(
            ThreadHistoryEntry(
                ...
                lastConfirmedAliveEpochMillis = 500L,
                replyCount = 1,
        ...
        assertNotNull(refreshOutcome.historyEntry?.lastConfirmedAliveEpochMillis)
        assertFalse(refreshOutcome.historyEntry.isAutoRefreshDisabled)
    ...
    @Test
    fun threadAutoSaveAvailability_handlesExtremePersistedTimestamps() {
        assertEquals(
            ThreadAutoSaveAvailability.Ready,
            resolveThreadAutoSaveAvailability(
                pageThreadId = "123",
                ...
                hasFileSystem = true,
                isAutoSaveInProgress = false,
                lastAutoSaveTimestampMillis = Long.MIN_VALUE,
        ...
        assertEquals(
            ...
            resolveThreadAutoSaveAvailability(
                ...
                hasFileSystem = true,
                isAutoSaveInProgress = false,
                lastAutoSaveTimestampMillis = Long.MAX_VALUE,
    ...
    fun mediaPreviewHelpers_buildEntries_detectTypes_and_wrapIndices() {
        ...
        assertEquals("件名", entries[0].title)
        assertEquals("本文1", resolveMediaPreviewDisplayTitle(entries[0]))
