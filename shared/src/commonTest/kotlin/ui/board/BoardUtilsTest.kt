...
class BoardUtilsTest {
    ...
    fun buildHistoryEntryFromPageAt_updatesExistingEntryAndPreservesExistingImage() {
        ...
        val offlineUpdated = buildHistoryEntryFromPageAt(
            page = page,
            history = listOf(existing),
            threadId = "123",
            threadTitle = null,
        ...
        assertEquals(500L, offlineUpdated.lastConfirmedAliveEpochMillis)
        assertEquals(true, offlineUpdated.isAutoRefreshDisabled)
    }
