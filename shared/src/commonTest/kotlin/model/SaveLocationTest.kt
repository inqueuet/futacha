...
class SaveLocationTest {
    @Test
    fun oversizedLegacyBookmarkCandidateIsNotDecoded() {
        val oversized = "A".repeat(MAX_SAVE_LOCATION_BOOKMARK_BASE64_CHARS + 1)
        assertIs<SaveLocation.Path>(SaveLocation.fromString(oversized))
    }
