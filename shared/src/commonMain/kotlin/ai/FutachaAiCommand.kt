...
enum class FutachaAiAction(
    ...
    EnableAiPostFilter("ai_post_filter_on", "荒らし非表示モードON", FutachaAiCommandRisk.Safe),
    DisableAiPostFilter("ai_post_filter_off", "荒らし非表示モードOFF", FutachaAiCommandRisk.Safe),
