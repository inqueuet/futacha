...
suspend fun SavedThreadRepository.planHistoryArchivePayload(
    ...
    archiveId: String,
    snapshotId: String
): Result<SavedThreadArchivePayloadPlan> = runSuspendCatchingPreservingCancellation {
    val metadata = loadThreadMetadata(historyEntry.threadId, historyEntry.boardId).getOrNull()
        ?: return@runSuspendCatchingPreservingCancellation historyOnlyArchivePayloadPlan(
