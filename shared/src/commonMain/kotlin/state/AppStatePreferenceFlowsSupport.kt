...
internal data class AppStatePreferenceFlows(
    ...
    val threadGalleryThumbnailMode: Flow<ThreadGalleryThumbnailMode>,
    ...
    val boardWatchWords: Flow<Map<String, List<String>>>,
...
internal fun buildAppStatePreferenceFlows(
    ...
    stringListMapSerializer: KSerializer<Map<String, List<String>>>,
    ...
    return AppStatePreferenceFlows(
        ...
        threadGalleryTapAction = storage.threadGalleryTapAction
            ...
            .distinctUntilChanged(),
        threadGalleryThumbnailMode = storage.threadGalleryThumbnailMode
            .map { raw -> decodeThreadGalleryThumbnailModeValue(raw) }
            .distinctUntilChanged(),
        ...
        catalogGridColumns = storage.catalogGridColumns
            ...
            .distinctUntilChanged(),
        catalogFetchRows = storage.catalogFetchRows
            .map { raw -> decodeCatalogFetchRowsValue(raw) }
            .distinctUntilChanged(),
        ...
        boardWatchWords = storage.boardWatchWordsJson
            .distinctUntilChanged()
            .map { raw ->
                withContext(AppDispatchers.parsing) {
