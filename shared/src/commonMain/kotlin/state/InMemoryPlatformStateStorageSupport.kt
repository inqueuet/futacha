...
internal open class BaseInMemoryPlatformStateStorage : PlatformStateStorage {
    ...
    val updateCheckState = MutableStateFlow(true)
    val watchAlertState = MutableStateFlow(false)
    ...
    val telemetryCollectionState = MutableStateFlow(true)
    ...
    val threadGalleryThumbnailModeState = MutableStateFlow<String?>(null)
    ...
    val compactThreadHeaderEnabledState = MutableStateFlow(false)
    ...
    val catalogFetchRowsState = MutableStateFlow<String?>(null)
    ...
    val boardWatchWordsState = MutableStateFlow<String?>(null)
    ...
    override val updateCheckEnabled: Flow<Boolean> = updateCheckState
    override val watchAlertEnabled: Flow<Boolean> = watchAlertState
    ...
    override val telemetryCollectionEnabled: Flow<Boolean> = telemetryCollectionState
    ...
    override val threadGalleryThumbnailMode: Flow<String?> = threadGalleryThumbnailModeState
    ...
    override val compactThreadHeaderEnabled: Flow<Boolean> = compactThreadHeaderEnabledState
    ...
    override val catalogFetchRows: Flow<String?> = catalogFetchRowsState
    ...
    override val boardWatchWordsJson: Flow<String?> = boardWatchWordsState
    ...
    override suspend fun updateUpdateCheckEnabled(enabled: Boolean) { updateCheckState.value = enabled }
    override suspend fun updateWatchAlertEnabled(enabled: Boolean) { watchAlertState.value = enabled }
    ...
    override suspend fun updateTelemetryCollectionEnabled(enabled: Boolean) { telemetryCollectionState.value = enabled }
    ...
    override suspend fun updateThreadGalleryThumbnailMode(mode: String) { threadGalleryThumbnailModeState.value = mode }
    ...
    override suspend fun updateCompactThreadHeaderEnabled(enabled: Boolean) {
        compactThreadHeaderEnabledState.value = enabled
    }
    ...
    override suspend fun updateCatalogFetchRows(rows: String) { catalogFetchRowsState.value = rows }
    ...
    override suspend fun updateBoardWatchWordsJson(value: String) { boardWatchWordsState.value = value }
    ...
    override suspend fun seedIfEmpty(seedBundles: AppStateSeedBundles) {
        seedMutex.withLock {
            ...
            if (threadGalleryThumbnailModeState.value == null) {
                threadGalleryThumbnailModeState.value = seedBundles.preferences.threadGalleryThumbnailMode
            }
