...
internal class AppStatePreferenceFacade(
    ...
    private val setCatalogFetchRowsImpl: suspend (Int) -> Unit,
    ...
    suspend fun setCatalogFetchRows(rows: Int) = setCatalogFetchRowsImpl(rows)
...
internal fun buildAppStatePreferenceFacade(
    ...
    setCatalogFetchRowsImpl: suspend (Int) -> Unit = {},
    ...
    return AppStatePreferenceFacade(
        ...
        setCatalogFetchRowsImpl = setCatalogFetchRowsImpl,
