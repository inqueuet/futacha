...
enum class AttachmentPickerPreference {
    ...
    DOCUMENT,
    ALWAYS_ASK,
    /** 1.apk posting picker: GET_CONTENT + OPENABLE with a remembered Activity component. */
    COMPAT_REFERENCE_GET_CONTENT,
    /** Legacy PostBuild contract: ACTION_GET_CONTENT without CATEGORY_OPENABLE. */
    LEGACY_GET_CONTENT
}
