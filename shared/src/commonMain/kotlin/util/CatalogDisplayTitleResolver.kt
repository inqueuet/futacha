...
private val titleCompletionHosts = setOf(
    // img and dat boards can return the reply count in the catalog's
    // subject slot.  The legacy APK repairs both by reading the thread head
    // before displaying or persisting the catalog title.
    "img.2chan.net",
    "dat.2chan.net"
)
