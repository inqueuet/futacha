...
private val INVALID_COMPAT_MANUAL_FOLDER_REGEX = Regex("""[\\/:*?\"<>|\u0000-\u001F]""")
...
/** Human-readable directory used by としあき(仮)'s manual image batch save. */
fun buildCompatManualImageFolderName(
    boardName: String,
    title: String,
    threadId: String
): String {
