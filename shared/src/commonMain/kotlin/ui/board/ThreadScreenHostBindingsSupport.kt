...
internal data class ThreadScreenHostRuntimeInputs(
    ...
    val searchScrollRequest: ThreadPostScrollRequest?,
...
internal fun buildThreadScreenHostBindingsBundle(
    ...
    return ThreadScreenHostBindingsBundle(
        scaffoldBindings = ThreadScreenScaffoldBindings(
            ...
            isHistoryRefreshing = scaffoldInputs.isHistoryRefreshing,
            ...
            compactHeader = scaffoldInputs.compactHeader,
        ...
        contentBindings = ThreadScreenContentHostBindings(
            ...
            postTextCache = contentInputs.postTextCache,
            lazyListState = contentInputs.lazyListState,
            searchScrollRequest = contentInputs.searchScrollRequest,
            onDisplayedPostsChanged = contentInputs.onDisplayedPostsChanged,
            newPostIds = contentInputs.newPostIds,
        ...
        overlayBindings = ThreadScreenOverlayHostBindings(
            ...
            onDismissAttachmentActionSheet = overlayInputs.onDismissAttachmentActionSheet,
            isSaidaneEnabled = overlayInputs.actionCallbacks.isSaidaneEnabled,
            onPreviewAttachment = overlayInputs.onPreviewAttachment,
            onJumpToAttachmentPost = overlayInputs.onJumpToAttachmentPost,
            onSaveAttachment = overlayInputs.onSaveAttachment,
            onOpenAttachmentExternally = overlayInputs.onOpenAttachmentExternally,
...
internal fun buildThreadScreenHostBindingsBundle(
    ...
    return buildThreadScreenHostBindingsBundle(
        scaffoldInputs = ThreadScreenHostScaffoldInputs(
            ...
            compactHeader = inputs.preferencesState.isCompactThreadHeaderEnabled,
        ...
        contentInputs = ThreadScreenHostContentInputs(
            ...
            postTextCache = inputs.postTextCache,
            lazyListState = inputs.lazyListState,
            searchScrollRequest = inputs.searchScrollRequest,
            onDisplayedPostsChanged = inputs.onDisplayedPostsChanged,
            newPostIds = inputs.newPostIds,
        ...
        overlayInputs = ThreadScreenHostOverlayInputs(
            ...
            onDismissAttachmentActionSheet = inputs.onDismissAttachmentActionSheet,
            onPreviewAttachment = inputs.onPreviewAttachment,
            onJumpToAttachmentPost = inputs.onJumpToAttachmentPost,
            onSaveAttachment = inputs.onSaveAttachment,
            onOpenAttachmentExternally = inputs.onOpenAttachmentExternally,
