...
internal data class CatalogScreenMutationInputs(
    ...
    val currentBoardWatchWordKey: () -> String?,
    val setCatalogMode: (CatalogMode) -> Unit,
    val currentCatalogNgWords: () -> List<String>,
    val currentGlobalWatchWords: () -> List<String>,
    val currentBoardWatchWords: () -> List<String>,
...
internal data class CatalogScreenRuntimeInputs(
    ...
    val currentIsCreateThreadSubmitting: () -> Boolean,
    val setIsCreateThreadSubmitting: (Boolean) -> Unit,
...
internal fun buildCatalogScreenInteractionBindingsBundle(
    ...
    val mutationBindings = buildCatalogScreenMutationBindings(
        ...
        currentBoardWatchWordKey = mutationInputs.currentBoardWatchWordKey,
        setCatalogMode = mutationInputs.setCatalogMode,
        currentCatalogNgWords = mutationInputs.currentCatalogNgWords,
        currentGlobalWatchWords = mutationInputs.currentGlobalWatchWords,
        currentBoardWatchWords = mutationInputs.currentBoardWatchWords,
    ...
    val runtimeBindings = buildCatalogScreenRuntimeBindingsBundle(
        ...
        currentIsCreateThreadSubmitting = runtimeInputs.currentIsCreateThreadSubmitting,
        setIsCreateThreadSubmitting = runtimeInputs.setIsCreateThreadSubmitting,
        ...
        onHistoryExport = runtimeInputs.onHistoryExport,
        onHistoryExportThenClear = runtimeInputs.onHistoryExportThenClear,
        onHistoryExportSelected = runtimeInputs.onHistoryExportSelected,
        onHistoryLoadImportPreview = runtimeInputs.onHistoryLoadImportPreview,
        onHistoryImport = runtimeInputs.onHistoryImport,
        onHistoryImportSelected = runtimeInputs.onHistoryImportSelected,
    ...
    val overlayBindings = buildCatalogScreenOverlayBindingsBundle(
        ...
        settingsInputs = CatalogScreenOverlaySettingsInputs(
            ...
            onAddGlobalWatchWord = mutationBindings.addGlobalWatchWordEntry,
            onRemoveGlobalWatchWord = mutationBindings.removeGlobalWatchWordEntry,
            onAddBoardWatchWord = mutationBindings.addBoardWatchWordEntry,
            onRemoveBoardWatchWord = mutationBindings.removeBoardWatchWordEntry,
            onClearBoardWatchWordsOverride = mutationBindings.clearBoardWatchWordsOverride
        )
    )
