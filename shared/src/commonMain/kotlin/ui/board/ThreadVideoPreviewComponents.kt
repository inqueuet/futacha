...
internal fun VideoPreviewDialog(
    ...
    var playbackError by remember(entry.url) { mutableStateOf<VideoPlaybackError?>(null) }
    ...
    ThreadMediaPreviewDialogFrame(
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            // native controls.
            val posterUrl = entry.previewUrl?.takeIf { it.isNotBlank() && it != entry.url }
            ...
            if (chromeState.showsError) {
                Column(
                    ...
                    TextButton(onClick = {
                        AnalyticsTracker.uiControl("video_preview_open_external", "動画をブラウザで開く")
