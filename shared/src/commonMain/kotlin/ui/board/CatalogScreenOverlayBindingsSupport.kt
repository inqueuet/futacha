...
internal data class CatalogScreenOverlaySettingsInputs(
    ...
    val onAddGlobalWatchWord: (String) -> Unit,
    val onRemoveGlobalWatchWord: (String) -> Unit,
    val onAddBoardWatchWord: (String) -> Unit,
    val onRemoveBoardWatchWord: (String) -> Unit,
    val onClearBoardWatchWordsOverride: () -> Unit
)
...
internal fun buildCatalogScreenOverlayBindingsBundle(
    ...
    return CatalogScreenOverlayBindingsBundle(
        ...
        watchWordsCallbacks = buildCatalogWatchWordsCallbacks(
            onAddGlobalWord = settingsInputs.onAddGlobalWatchWord,
            onRemoveGlobalWord = settingsInputs.onRemoveGlobalWatchWord,
            onAddBoardWord = settingsInputs.onAddBoardWatchWord,
            onRemoveBoardWord = settingsInputs.onRemoveBoardWatchWord,
            onClearBoardOverride = settingsInputs.onClearBoardWatchWordsOverride,
            setIsWatchWordsVisible = settingsInputs.setIsWatchWordsVisible
        ),
