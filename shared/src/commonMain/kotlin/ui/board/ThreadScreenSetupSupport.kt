...
internal data class ThreadScreenContentContext(
    ...
    val onBack: () -> Unit,
    val onScrollPositionPersist: (threadId: String, index: Int, offset: Int, postId: String?) -> Unit,
    val onScrollPositionPersistImmediately: (threadId: String, index: Int, offset: Int, postId: String?) -> Unit,
...
internal data class ThreadScreenContextHandles(
    ...
    val onHistoryLoadImportPreview: suspend () -> com.valoser.futacha.shared.ui.FutachaHistoryArchivePreview?,
    ...
    val compatibilityStore: com.valoser.futacha.shared.compat.CompatibilityStore?,
...
internal fun resolveThreadScreenPreparedSetupHandles(
    ...
    return ThreadScreenPreparedSetupHandles(
        contextHandles = ThreadScreenContextHandles(
            ...
            onHistoryExport = context.onHistoryExport,
            onHistoryExportThenClear = context.onHistoryExportThenClear,
            onHistoryExportSelected = context.onHistoryExportSelected,
            onHistoryLoadImportPreview = context.onHistoryLoadImportPreview,
            onHistoryImport = context.onHistoryImport,
            onHistoryImportSelected = context.onHistoryImportSelected,
            httpClient = context.httpClient,
            fileSystem = context.fileSystem,
            cookieRepository = context.cookieRepository,
            stateStore = context.stateStore,
            compatibilityStore = context.services.compatibilityStore,
        ...
        setupHandles = ThreadScreenSetupHandles(
            ...
            importedHistoryRepository = environmentBundle.importedHistoryRepository,
