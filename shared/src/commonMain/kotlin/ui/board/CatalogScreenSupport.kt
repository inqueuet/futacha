...
// Covers both bounded network attempts and their retry delay. The previous
// 20-second UI timeout cancelled HttpBoardApi before its first 35-second
// attempt (and therefore before its retry) could complete.
internal const val CATALOG_LOAD_TIMEOUT_MS = 75_000L
