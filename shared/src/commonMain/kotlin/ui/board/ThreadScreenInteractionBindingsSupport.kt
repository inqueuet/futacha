...
internal data class ThreadScreenSearchInteractionInputs(
    ...
    val onCloseDrawerAfterHistorySelection: suspend () -> Unit,
...
internal fun buildThreadScreenInteractionBindingsBundle(
    ...
    val historySelectionHandler = buildThreadScreenHistorySelectionHandler(
        coroutineScope = searchInputs.coroutineScope,
    ...
    return ThreadScreenInteractionBindingsBundle(
        menuEntryHandler = buildThreadScreenMenuEntryHandler(
            ...
            analyticsContext = menuInputs.analyticsContext,
        ...
        searchNavigationCallbacks = buildThreadScreenSearchNavigationCallbacks(
            ...
            currentSearchQuery = searchInputs.currentSearchQuery,
            analyticsContext = searchInputs.analyticsContext,
        ...
        historyDrawerCallbacks = buildThreadScreenHistoryDrawerCallbacks(
            ...
            onExportClick = historyDrawerInputs.onHistoryExportClick,
            onExportThenClearClick = historyDrawerInputs.onHistoryExportThenClearClick,
            onExportSelectedClick = historyDrawerInputs.onHistoryExportSelectedClick,
            onLoadImportPreview = historyDrawerInputs.onHistoryLoadImportPreview,
            onImportClick = historyDrawerInputs.onHistoryImportClick,
            onImportSelectedClick = historyDrawerInputs.onHistoryImportSelectedClick,
