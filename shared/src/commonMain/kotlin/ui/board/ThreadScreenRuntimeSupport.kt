...
// Match the reference foreground-save protection window. A 15-minute ceiling
// aborts legitimate 1000-reply image/video saves on slower storage or networks.
internal const val THREAD_MANUAL_SAVE_TIMEOUT_MS = 3 * 60 * 60_000L
