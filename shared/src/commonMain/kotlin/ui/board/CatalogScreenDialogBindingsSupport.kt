...
internal data class CatalogWatchWordsCallbacks(
    val onAddGlobalWord: (String) -> Unit,
    val onRemoveGlobalWord: (String) -> Unit,
    val onAddBoardWord: (String) -> Unit,
    val onRemoveBoardWord: (String) -> Unit,
    val onClearBoardOverride: () -> Unit,
    val onDismiss: () -> Unit
)
...
internal fun buildCatalogWatchWordsCallbacks(
    ...
    return CatalogWatchWordsCallbacks(
        onAddGlobalWord = onAddGlobalWord,
        onRemoveGlobalWord = onRemoveGlobalWord,
        onAddBoardWord = onAddBoardWord,
        onRemoveBoardWord = onRemoveBoardWord,
        onClearBoardOverride = onClearBoardOverride,
