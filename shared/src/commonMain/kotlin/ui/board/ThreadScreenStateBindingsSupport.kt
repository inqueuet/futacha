...
internal fun buildThreadScreenJobBindings(
    ...
    return ThreadScreenJobBindings(
        ...
        resetForThreadChange = {
            ...
            // A user initiated page save is application-scoped and protected by
            // the platform background mechanism. Switching threads must not
            // abort it; cancellation remains available from the progress UI or
